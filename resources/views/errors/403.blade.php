<x-frontend.layouts.app :seoTitle="'403 | Access Denied'">
    <section class="relative overflow-hidden bg-night">
        ...
        <div class="container-app relative flex min-h-screen flex-col items-center justify-center py-32 text-center">
            <p class="font-display text-8xl font-bold md:text-9xl">
                <span class="bg-gradient-to-r from-violet-300 via-violet-400 to-violet-200 bg-clip-text text-transparent">403</span>
            </p>
            <h1 class="mt-4 text-2xl font-semibold text-white md:text-3xl">Access Denied</h1>
