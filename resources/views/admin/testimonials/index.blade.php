<x-admin.layouts.app :title="'Testimonials'">
    <div data-ajax-list="results">
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <form method="GET" action="{{ route('admin.testimonials.index') }}" class="flex w-full gap-2 sm:max-w-md">
            ...
            <a href="{{ route('admin.testimonials.create') }}" class="inline-flex items-center justify-center gap-2 rounded-lg bg-navy-900 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-navy-800">
